...
public class WebServiceClient {
    ...
    public static WebServiceResponse authenticate(Context context, String wsUsername, String wsPassword) {
        //wsUsername = "renan@dm114.com.br";
        //wsPassword = "inatel";
        ...
        try {
            ...
            if(wsUsername == null && wsPassword == null) {
                wsUsername = sharedpreferences.getString(
                        context.getString(R.string.pref_user_login), wsUsername);
                wsPassword = sharedpreferences.getString(
                        context.getString(R.string.pref_user_password), wsPassword);
            }
            ...
            if (conn.getResponseCode() == 200) {
                ...
                editor.putLong(context.getString(R.string.pref_ws_access_token_expiration),
                        Calendar.getInstance().getTime().getTime() + accessToken.getExpires_in() * 1000);
                editor.putString(context.getString(R.string.pref_user_login), wsUsername);
                editor.putString(context.getString( R.string.pref_user_password), wsPassword);
                editor.commit();
